...
public class Bus {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int N = Integer.parseInt(br.readLine()); //vozrasni
        int M = Integer.parseInt(br.readLine());  //deca
    ...
    private static int maxCost(int n, int m) {
        return n * 100 + Math.max(0, m - 1) * 100;
    }

    private static int minCost(int n, int m) {
        return n * 100 + Math.max(0, m - n) * 100;
    }
